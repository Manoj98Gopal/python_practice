# Generated by Django 5.0.3 on 2024-03-18 00:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('P', 'Pending'), ('F', 'Faild'), ('S', 'Success')], default='P', max_length=1)),
        ...
        migrations.AddField(
            ...
            name='product',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='products_in_collection', to='store.product'),
        ),
        migrations.CreateModel(
            name='CartItem',
            fields=[
